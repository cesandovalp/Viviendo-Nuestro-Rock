...
function app() {
    ...
    var compass = new Compass(23, document.querySelector('.compass'));
}
...
function Orbiter(compass, index) {
    ...
    img.src = "https://cesandovalp.github.io/Images/" + ((index % 2021) + 1997) + ".png";
    this.img = img;
...
Orbiter.prototype.setTransform = function(i, container_width, rotation, deg_per_orbiter) {
    var starting_deg = 90,
        ...
        selected = (m360 > 180 - deg_per_orbiter_d_2 && m360 < 180 + deg_per_orbiter_d_2),
